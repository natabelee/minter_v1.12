TG_TOKEN = 'your_tgbot_token' # создать это можешь здесь : https://t.me/BotFather
TG_ID = 0 # узнать то можешь там : https://t.me/getmyid_bot

API_0x = 'your_0x_api_key' # получить api key от 0x надо здесь : https://dashboard.0x.org/apps

# меняем эти рпс на свои
DATA = {
